...
> **罄竹难书**
{.is-warning}
#### 作用机理^[[Wikipedia](https://en.wikipedia.org/wiki/Quetiapine)]~你没看错，就是这么多！~
- 拮抗受体：α~1A~, α~1B~, α~2A~, α~2B~, α~2C~
- 拮抗受体：β~1~, β~2~
- 拮抗受体：多巴胺/D~1~, D~2~, D~2L~, D~2S~, D~3~, D~4~, D~4.2~, D~5~
